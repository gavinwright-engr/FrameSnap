...
$command = @(
    ...
    "link /OUT:`"$outputExe`" /SUBSYSTEM:WINDOWS *.obj app.res user32.lib gdi32.lib comdlg32.lib d3d11.lib dxgi.lib d2d1.lib windowscodecs.lib gdiplus.lib comctl32.lib dwmapi.lib shcore.lib shell32.lib ole32.lib advapi32.lib shlwapi.lib winmm.lib",
    "del /q *.obj 2>nul",
    "del /q app.res 2>nul"
) -join " && "
